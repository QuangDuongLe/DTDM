...
<div class="side-bar">
  ...
  <ul class="menu">
    ...
    <li><img src="images/table.png"><a onclick="toggle(this);">Show table</li>
    <li><img src="images/product.png"><a href="ShowServlet" class="active">Show product</a></li>
  </ul>
</div>
<div class="container">
  <div class="header">
  ...
  <div class="content">
    ...
    <div>
        <table class="producttb" id="mytable" hidden>
          <thead>
          <tr>
            <th>ID</th>
            <th>Product ID</th>
...
<script>
  let toggle = li => {
    ...
    if (hidden) {
        ...
        li.innerText = "Close table";

    } else {
        element.setAttribute("hidden", "hidden");
        li.innerText = "Show table";
    }
  }
</script>
</body>
